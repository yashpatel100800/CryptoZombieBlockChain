...
contract ZombieFactory is Ownable {
  ...
  function createMultipleZombies(string memory _name) public {
      uint randDna = _generateRandomDna(_name);
      randDna = randDna - randDna % 100;
      _createZombie(_name, randDna);
}
  ...
  function deleteZombie(uint256 zombieId) public {
    require(msg.sender == zombieToOwner[zombieId], "You are not the owner of this zombie");
